 ...
 */
@property (nonatomic, copy) void (^onConnectionOpen)(MDWampClient *client);

/**
 * If implemented gets called when client close the connection, or fails to connect
 */
@property (nonatomic, copy) void (^onConnectionClose)(MDWampClient *client, NSInteger code, NSString *reason);
